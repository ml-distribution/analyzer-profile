...
import info.bbd.analyzer.mmseg4j.rule.LargestAvgLenRule;
import info.bbd.analyzer.mmseg4j.rule.LargestSumDegreeFreedomRule;
import info.bbd.analyzer.mmseg4j.rule.MaxMatchRule;
import info.bbd.analyzer.mmseg4j.rule.Rule;
import info.bbd.analyzer.mmseg4j.rule.SmallestVarianceRule;
