...
public class TestSmartChineseAnalyzer extends BaseTokenStreamTestCase {
	...
	public void testChineseStopWordsOff() throws Exception {
		Analyzer[] analyzers = new Analyzer[] { new SmartChineseAnalyzer(false),/* doesn't load stopwords */
	...
	public void testMixedLatinChinese() throws Exception {
		...
		assertAnalyzesTo(analyzer, "我购买 Tests 了道具和服装", new String[] { "我", "购买", "test", "了", "道具", "和", "服装" });
		analyzer.close();
	}
	...
	public void testNumerics() throws Exception {
		Analyzer analyzer = new SmartChineseAnalyzer(true);
		assertAnalyzesTo(analyzer, "我购买 Tests 了道具和服装1234", new String[] { "我", "购买", "test", "了", "道具", "和", "服装",
				"1234" });
		analyzer.close();
	}
	...
	public void testFullWidth() throws Exception {
		Analyzer analyzer = new SmartChineseAnalyzer(true);
		assertAnalyzesTo(analyzer, "我购买 Ｔｅｓｔｓ 了道具和服装１２３４", new String[] { "我", "购买", "test", "了", "道具", "和", "服装",
				"1234" });
		analyzer.close();
	}
	...
	public void testNonChinese() throws Exception {
		Analyzer analyzer = new SmartChineseAnalyzer(true);
		assertAnalyzesTo(analyzer, "我购买 روبرتTests 了道具和服装", new String[] { "我", "购买", "ر", "و", "ب", "ر", "ت", "test",
				"了", "道具", "和", "服装" });
		analyzer.close();
	}
	...
	public void testOffsets() throws Exception {
		Analyzer analyzer = new SmartChineseAnalyzer(true);
		assertAnalyzesTo(analyzer, "我购买了道具和服装", new String[] { "我", "购买", "了", "道具", "和", "服装" }, new int[] { 0, 1, 3,
				4, 6, 7 }, new int[] { 1, 3, 4, 6, 7, 9 });
		analyzer.close();
	}
