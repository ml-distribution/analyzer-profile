package info.bbd.analyzer.ik.core;
...
import info.bbd.analyzer.ik.conf.Configuration;
import info.bbd.analyzer.ik.conf.DefaultConfig;
import info.bbd.analyzer.ik.dic.Dictionary;
