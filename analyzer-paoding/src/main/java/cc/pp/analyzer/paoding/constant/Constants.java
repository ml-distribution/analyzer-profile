package cc.pp.analyzer.paoding.constant;
...
public class Constants {
	...
	// -------------------------------------------------------------
	private static final Map/* <String, String> */<String, String> map = new HashMap<String, String>();
	...
	public static String getProperty(Properties p, String name) {
		return p.getProperty(name, map.get(name));
	}
}
