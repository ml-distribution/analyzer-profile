...
public class SimpleReadListener implements ReadListener {
	...
	private final Map/* <String, Set<Word>> */<String, Set<Word>> dics = new Hashtable/* <String, Set<Word>> */<String, Set<Word>>();
	private Set<Word> words = new HashSet/* <Word> */<Word>();
	...
	public Map/* <String, Set<String>> */<String, Set<Word>> getResult() {
		return dics;
	}
