...
public class HashBinaryDictionary implements Dictionary {
	 ...
	 */
	private final Word[] ascWords;

	/**
	 * 首字符到分词典的映射
	 */
	private final Map/* <Object, SubDictionaryWrap> */<Object, SubDictionaryWrap> subs;
	...
	public HashBinaryDictionary(Word[] ascWords, int hashIndex, int start,
		...
		subs = new HashMap/* <Object, SubDictionaryWrap> */<Object, SubDictionaryWrap>(initialCapacity,
				loadFactor);
	...
	public Hit search(CharSequence input, int begin, int count) {
		SubDictionaryWrap subDic = subs.get(keyOf(input
